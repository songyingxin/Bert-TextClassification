...
def train(model, dataloader, optimizer, criterion, gradient_accumulation_steps, device, label_list):
    ...
    report, acc = utils.classifiction_metric(all_preds, all_labels, label_list)
...
def main(config):
    ...
    for epoch in range(int(config.num_train_epochs)):
        ...
        train_loss, train_acc, train_report = train(model, train_dataloader, optimizer, criterion, config.gradient_accumulation_steps, device, label_list)
